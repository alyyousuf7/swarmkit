...
-----END EC PRIVATE KEY-----
`)
	// ECDSA256PKCS8Key is an ECDSA curve-P256 key.
	ECDSA256PKCS8Key = []byte(`
-----BEGIN PRIVATE KEY-----
MIGTAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBHkwdwIBAQQgpeS8V9RxVsf1SrGR
2jg5vBzdFIl8Qfbbnix+qTHnTEGgCgYIKoZIzj0DAQehRANCAAR5sn4BSS7veCMj
2HmL/5Wg1HunF3GVmS+tnVt7ZutWFA0UG+e8ycb2iHh7HeyltGMEBGznodkKNFGm
+PqYE7Il
-----END PRIVATE KEY-----
`)
